            ...
            <div className=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div className="footer-widget">
                ...
                <div className="ft-social">
                  ...
                  <span><a href="#" className="btn-social btn-googleplus"><i
                    className="fa fa-google-plus"></i></a></span>
                  <span><a href="#" className=" btn-social btn-linkedin"><i className="fa fa-linkedin"></i></a></span>
                  <span><a href="#" className=" btn-social btn-pinterest"><i
                    className="fa fa-pinterest-p"></i></a></span>
